...
![Alt text](C:/Users/Allison/Desktop/SMU/19U/Doing Data Science/R/awesome-public-datasets-filepath.png)

# Question 2

```{r}
# Set working directory for entire assignment
# we cannot run setwd() when we knit, so we put the entire path, or we add this to the r setup chunk:
# knitr::opts_knit$set(root.dir = "some path") and then write all the paths relative to that
#
#setwd("C:/Users/Allison/Desktop/SMU/19U/Doing Data Science/R/")

# Part a - read titanic.csv data
# install.packages("readr",repos = "http://cran.us.r-project.org")
# library(readr,lib.loc="C:/Users/Allison/Documents/R/win-library/3.5")
library(readr)
# if this becomes too much of a pain, just unzip the csv manually and do read.csv(), but readr definitely recommended :)
...
# Pary c - means of Age, Fare, and Survival
